...
function SvgLineDiscovery(props) {
  ...
  return (
    ...
    >
      <G scale={1}>
        ...
        />
        <Path
          d="M10.182 11.296a2 2 0 011.114-1.114l2.038-.815c.816-.327 1.626.483 1.3 1.3l-.816 2.037a2 2 0 01-1.114 1.114l-2.037.815c-.817.327-1.627-.483-1.3-1.3l.815-2.037z"
          stroke={props.color || theme?.colors?.black || '#212121'}
          strokeWidth={1.5}
          strokeLinecap="round"
...
export default SvgLineDiscovery
